...
/*   Updated: 2018/01/12 13:17:21 by qduperon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
  ...
  SuperTrap ClapTrapUltim("ClapTrapUltim");
  std::cout << std::endl;
  ...
  std::cout << std::endl;
  std::cout << "SuperTrap's test" << std::endl;
  std::cout << std::endl;

  ClapTrapUltim.meleeAttack("Sandy");
  ClapTrapUltim.rangedAttack("Sandy");

  ClapTrapUltim.takeDamage(105);
  ClapTrapUltim.takeDamage(90);
  ClapTrapUltim.takeDamage(0);

  ClapTrapUltim.beRepaired(5000);
  ClapTrapUltim.beRepaired(5);

  ClapTrapUltim.ninjaShoebox(ClapTrap);
  ClapTrapUltim.ninjaShoebox(ClapTrap2);
  ClapTrapUltim.ninjaShoebox(ClapTrap4);

  ClapTrapUltim.vaulthunter_dot_exe("Sandy");
  ClapTrapUltim.vaulthunter_dot_exe("Sandy");
  ClapTrapUltim.vaulthunter_dot_exe("Sandy");
  ClapTrapUltim.vaulthunter_dot_exe("Sandy");
  ClapTrapUltim.vaulthunter_dot_exe("Sandy");
  ...
  std::cout << std::endl;
  std::cout << "end of SuperTrap's test " << std::endl;
  std::cout << std::endl;
